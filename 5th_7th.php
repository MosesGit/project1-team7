<?php $parentTitle = "Pokémon Generation Wiki"; $currentTitle = "5th-7th Generations"; $separator = " - "; include "inc/top.inc";?>
		...
		<article class="col-md-12">
			...
			<img class="img-responsive" src="images/Znt5Fee.png" alt="6thGen">
