<?php $parentTitle = "Pokemon Generation Wiki"; $currentTitle = "3th-4th Gen"; $separator = " - "; include "inc/top.inc";?>

		<?php include "inc/nav.inc";?>

		<article class="col-md-8">
			
			<h2>3rd - 4th Generations</h2>
			
			<img src="http://www.spriters-resource.com/resources/sheets/62/64887.png" alt="3rdGen">
