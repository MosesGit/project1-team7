<?php $parentTitle = "Pokemon Generation Wiki"; include "inc/top.inc";?>
		...
		<article class="col-md-8">
			...
			<img class="img-responsive" src="http://toucharcade.com/wp-content/uploads/2016/07/landscape-1456483171-pokemon2.jpg" alt="overview">
		...
		<aside class="col-md-4">
			...
			<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/English_Pok%C3%A9mon_logo.svg/269px-English_Pok%C3%A9mon_logo.svg.png" alt="logo">
			...
			<p>Games are commonly released in pairs—each with slight variations—and then an enhanced remake of the games is released a few years after the original releases. While the main series consists of role-playing games, spinoffs encompass other genres, such as action role-playing, puzzle, and digital pet games. As of February 2016, more than 279 million units have been sold worldwide, more than 200 million of which from the main series,[1] making it the second best-selling video game franchise, behind only Nintendo's own Mario franchise. The franchise's mascot is Pikachu.</p>
		</aside>
